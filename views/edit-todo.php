...
<main class="container">
  <div class="mx-auto">
    ...
    <h2 class="display-2"><i class="fa-solid fa-pencil"></i>Edit To do</h2>
  </div>
    <form action="../actions/edit-todo.php?todo_id=<?= $todo_list['todo_id'] ?>" method="post">
      <div class="w-50 mx-auto">
        <input type="text" name="todo_title" id="todo_title" class="border-top-0 border-start-0 border-end-0 form-control" value="<?=$todo_list['todo_title']?>" required autofocus>
        ...
        <input type="number" name="todo_priority" id="todo_priority" class="mt-3 border-top-0 border-start-0 border-end-0 form-control" value="<?=$todo_list['todo_priority']?>" required>
        <input type="text" name="todo_deadline"  id="todo_deadline" onfocus="this.type='date'" onfocusout="this.type='text'" value="<?=$todo_list['todo_deadline']?>"  class="mt-3 border-top-0 border-start-0 border-end-0 form-control"  required>
